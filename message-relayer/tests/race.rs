...
//!  * a fixture publisher injecting `MessagePublished` then a quorum of attestor votes,
...
#[tokio::test]
#[ignore = "requires anvil + a fixture attestor publisher; tracked under PR6 hardening"]
